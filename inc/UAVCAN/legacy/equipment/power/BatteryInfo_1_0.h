...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/power/BatteryInfo.1.0.uavcan
// Generated at:  2021-03-29 14:11:51.834319 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/power/BatteryInfo.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_power_BatteryInfo_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint11 status_flags
        ...
        (void) memmove(&buffer[offset_bits / 8U], &_sat7_, 2U);
        offset_bits += 11U;
    }
    ...
    {   // saturated uint7 state_of_health_pct
        ...
        const int8_t _err0_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat8_, 7U);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    {   // saturated uint7 state_of_charge_pct
        ...
        const int8_t _err1_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat9_, 7U);
        if (_err1_ < 0)
        {
            return _err1_;
        }
    ...
    {   // saturated uint7 state_of_charge_pct_stdev
        ...
        const int8_t _err2_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat10_, 7U);
        if (_err2_ < 0)
        {
            return _err2_;
        }
    ...
    {   // saturated uint32 model_instance_id
        // Saturation code not emitted -- native representation matches the serialized representation.
        (void) memmove(&buffer[offset_bits / 8U], &obj->model_instance_id, 4U);
        offset_bits += 32U;
    }
