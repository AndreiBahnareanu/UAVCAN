...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/ahrs/RawIMU.1.0.uavcan
// Generated at:  2021-03-29 14:11:40.854007 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/ahrs/RawIMU.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_ahrs_RawIMU_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float32 integration_interval
        ...
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        (void) memmove(&buffer[offset_bits / 8U], &obj->integration_interval, 4U);
        offset_bits += 32U;
    }
    ...
    {   // saturated float32[3] rate_gyro_integral
        ...
        nunavutCopyBits(&buffer[0], offset_bits, 3UL * 32UL, &obj->rate_gyro_integral[0], 0U);
    ...
    {   // saturated float32[3] accelerometer_integral
        ...
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        // Optimization prospect: this item is aligned at the byte boundary, so it is possible to use memmove().
        nunavutCopyBits(&buffer[0], offset_bits, 3UL * 32UL, &obj->accelerometer_integral[0], 0U);
        offset_bits += 3UL * 32UL;
    }
    ...
    legacy_equipment_ahrs_RawIMU_1_0* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // saturated float32[3] rate_gyro_integral
    static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
    nunavutGetBits(&out_obj->rate_gyro_integral[0], &buffer[0], capacity_bytes, offset_bits, 3UL * 32U);
    offset_bits += 3UL * 32U;
    ...
    // saturated float32[3] accelerometer_integral
    static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
    nunavutGetBits(&out_obj->accelerometer_integral[0], &buffer[0], capacity_bytes, offset_bits, 3UL * 32U);
    offset_bits += 3UL * 32U;
