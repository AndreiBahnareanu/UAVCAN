...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/ahrs/Solution.1.0.uavcan
// Generated at:  2021-03-29 14:11:41.280178 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/ahrs/Solution.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_ahrs_Solution_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float16[<=9] orientation_covariance
        ...
        const int8_t _err1_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->orientation_covariance.count, 8U);
        if (_err1_ < 0)
        {
            return _err1_;
        }
        ...
        for (size_t _index0_ = 0U; _index0_ < obj->orientation_covariance.count; ++_index0_)
        {
            ...
            const int8_t _err2_ = nunavutSetF16(&buffer[0], capacity_bytes, offset_bits, _sat4_);
            if (_err2_ < 0)
            {
                return _err2_;
            }
    ...
    {   // saturated float16[3] angular_velocity
        ...
        {   // Array element #0
            ...
            const int8_t _err3_ = nunavutSetF16(&buffer[0], capacity_bytes, offset_bits, _sat5_);
            if (_err3_ < 0)
            {
                return _err3_;
            }
        ...
        {   // Array element #1
            ...
            const int8_t _err4_ = nunavutSetF16(&buffer[0], capacity_bytes, offset_bits, _sat6_);
            if (_err4_ < 0)
            {
                return _err4_;
            }
        ...
        {   // Array element #2
            ...
            const int8_t _err5_ = nunavutSetF16(&buffer[0], capacity_bytes, offset_bits, _sat7_);
            if (_err5_ < 0)
            {
                return _err5_;
            }
    ...
    {   // saturated float16[<=9] angular_velocity_covariance
        ...
        for (size_t _index1_ = 0U; _index1_ < obj->angular_velocity_covariance.count; ++_index1_)
        {
            ...
            const uint16_t _half4_ = nunavutFloat16Pack(_sat8_);
    ...
    {   // saturated float16[3] linear_acceleration
        ...
        {   // Array element #0
            ...
            const uint16_t _half5_ = nunavutFloat16Pack(_sat9_);
        ...
        {   // Array element #1
            ...
            const uint16_t _half6_ = nunavutFloat16Pack(_sat10_);
        ...
        {   // Array element #2
            ...
            const uint16_t _half7_ = nunavutFloat16Pack(_sat11_);
    ...
    {   // saturated float16[<=9] linear_acceleration_covariance
        ...
        for (size_t _index2_ = 0U; _index2_ < obj->linear_acceleration_covariance.count; ++_index2_)
        {
            ...
            const uint16_t _half8_ = nunavutFloat16Pack(_sat12_);
