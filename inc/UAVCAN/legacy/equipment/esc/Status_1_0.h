...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/esc/Status.1.0.uavcan
// Generated at:  2021-03-29 14:11:42.808202 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/esc/Status.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_esc_Status_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated int18 rpm
        ...
        (void) memmove(&buffer[offset_bits / 8U], &_sat3_, 3U);
        offset_bits += 18U;
    }
    ...
    {   // saturated uint7 power_rating_pct
        ...
        const int8_t _err0_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat4_, 7U);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    {   // saturated uint5 esc_index
        ...
        const int8_t _err1_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat5_, 5U);
        if (_err1_ < 0)
        {
            return _err1_;
        }
...
static inline int8_t legacy_equipment_esc_Status_1_0_deserialize_(
    legacy_equipment_esc_Status_1_0* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
