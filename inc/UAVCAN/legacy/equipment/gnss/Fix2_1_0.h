...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/gnss/Fix2.1.0.uavcan
// Generated at:  2021-03-29 14:11:45.809319 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/equipment/gnss/Fix2.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_gnss_Fix2_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated int37 longitude_deg_1e8
        ...
        (void) memmove(&buffer[offset_bits / 8U], &_sat1_, 5U);
        offset_bits += 37U;
    }
    ...
    {   // saturated int37 latitude_deg_1e8
        ...
        const int8_t _err4_ = nunavutSetIxx(&buffer[0], capacity_bytes, offset_bits, _sat2_, 37U);
        if (_err4_ < 0)
        {
            return _err4_;
        }
    ...
    {   // saturated int27 height_ellipsoid_mm
        ...
        const int8_t _err5_ = nunavutSetIxx(&buffer[0], capacity_bytes, offset_bits, _sat3_, 27U);
        if (_err5_ < 0)
        {
            return _err5_;
        }
    ...
    {   // saturated int27 height_msl_mm
        ...
        const int8_t _err6_ = nunavutSetIxx(&buffer[0], capacity_bytes, offset_bits, _sat4_, 27U);
        if (_err6_ < 0)
        {
            return _err6_;
        }
    ...
    {   // saturated float32[3] ned_velocity
        ...
        nunavutCopyBits(&buffer[0], offset_bits, 3UL * 32UL, &obj->ned_velocity[0], 0U);
    ...
    {   // saturated uint2 status
        ...
        const int8_t _err7_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat6_, 2U);
        if (_err7_ < 0)
        {
            return _err7_;
        }
    ...
    {   // saturated uint6 sub_mode
        ...
        const int8_t _err8_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat8_, 6U);
        if (_err8_ < 0)
        {
            return _err8_;
        }
    ...
    {   // saturated float16[<=36] covariance
        ...
        const int8_t _err9_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->covariance.count, 8U);
        if (_err9_ < 0)
        {
            return _err9_;
        }
    ...
    if (offset_bits % 8U != 0U)  // Pad to 8 bits. TODO: Eliminate redundant padding checks.
    {
        ...
        const int8_t _err12_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, 0U, _pad1_);  // Optimize?
        if (_err12_ < 0)
        {
            return _err12_;
        }
    ...
    legacy_equipment_gnss_Fix2_1_0* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.time.SynchronizedTimestamp.1.0 timestamp
    {
        ...
        const int8_t _err13_ = uavcan_time_SynchronizedTimestamp_1_0_deserialize_(
    ...
    // saturated float32[3] ned_velocity
    static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
    nunavutGetBits(&out_obj->ned_velocity[0], &buffer[0], capacity_bytes, offset_bits, 3UL * 32U);
    offset_bits += 3UL * 32U;
