...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/AccessCommandShell.1.0.uavcan
// Generated at:  2021-03-29 14:11:25.915885 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/AccessCommandShell.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_protocol_AccessCommandShell_Response_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated int32 last_exit_status
        // Saturation code not emitted -- native representation matches the serialized representation.
        (void) memmove(&buffer[offset_bits / 8U], &obj->last_exit_status, 4U);
        offset_bits += 32U;
    }
    ...
    {   // saturated uint8[<=256] output
        ...
        (void) memmove(&buffer[offset_bits / 8U], &obj->output.count, 2U);
        offset_bits += 16U;
        // Optimization prospect: this item is aligned at the byte boundary, so it is possible to use memmove().
