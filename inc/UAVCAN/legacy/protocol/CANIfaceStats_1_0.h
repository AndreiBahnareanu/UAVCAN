...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/CANIfaceStats.1.0.uavcan
// Generated at:  2021-03-29 14:11:26.877707 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/CANIfaceStats.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_protocol_CANIfaceStats_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint48 frames_tx
        ...
        (void) memmove(&buffer[offset_bits / 8U], &_sat0_, 6U);
        offset_bits += 48U;
    }
    ...
    {   // saturated uint48 frames_rx
        ...
        (void) memmove(&buffer[offset_bits / 8U], &_sat1_, 6U);
        offset_bits += 48U;
    }
    ...
    {   // saturated uint48 errors
        ...
        (void) memmove(&buffer[offset_bits / 8U], &_sat2_, 6U);
        offset_bits += 48U;
    }
...
static inline int8_t legacy_protocol_CANIfaceStats_1_0_deserialize_(
    legacy_protocol_CANIfaceStats_1_0* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
