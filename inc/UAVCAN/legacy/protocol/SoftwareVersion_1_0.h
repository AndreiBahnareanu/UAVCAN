...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/SoftwareVersion.1.0.uavcan
// Generated at:  2021-03-29 14:11:31.298188 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/SoftwareVersion.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_protocol_SoftwareVersion_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint32 vcs_commit
        // Saturation code not emitted -- native representation matches the serialized representation.
        (void) memmove(&buffer[offset_bits / 8U], &obj->vcs_commit, 4U);
        offset_bits += 32U;
    }
    ...
    {   // saturated uint64 image_crc
        // Saturation code not emitted -- native representation matches the serialized representation.
        (void) memmove(&buffer[offset_bits / 8U], &obj->image_crc, 8U);
        offset_bits += 64U;
    }
