...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/NodeStatus.1.0.uavcan
// Generated at:  2021-03-29 14:11:29.328046 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/NodeStatus.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_protocol_NodeStatus_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint32 uptime_sec
        ...
        (void) memmove(&buffer[offset_bits / 8U], &obj->uptime_sec, 4U);
        offset_bits += 32U;
    }
    ...
    {   // saturated uint3 sub_mode
        ...
        const int8_t _err1_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat2_, 3U);
        if (_err1_ < 0)
        {
            return _err1_;
        }
    ...
    {   // saturated uint16 vendor_specific_status_code
        // Saturation code not emitted -- native representation matches the serialized representation.
        (void) memmove(&buffer[offset_bits / 8U], &obj->vendor_specific_status_code, 2U);
        offset_bits += 16U;
    }
