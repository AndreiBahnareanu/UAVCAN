...
// Source file:   /home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/dynamic_node_id/server/AppendEntries.1.0.uavcan
// Generated at:  2021-03-29 14:11:33.802369 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/andrei/UAVCAN/public_regulated_data_types/legacy/protocol/dynamic_node_id/server/AppendEntries.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_protocol_dynamic_node_id_server_AppendEntries_Request_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // legacy.protocol.dynamic_node_id.server.Entry.1.0[<=1] entries
        ...
        for (size_t _index0_ = 0U; _index0_ < obj->entries.count; ++_index0_)
        {
            ...
            offset_bits += 32U;
            int8_t _err1_ = legacy_protocol_dynamic_node_id_server_Entry_1_0_serialize_(
    ...
    {
        {
            ...
            const int8_t _err3_ = legacy_protocol_dynamic_node_id_server_Entry_1_0_deserialize_(
